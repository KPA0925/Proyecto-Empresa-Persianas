...
<template>
    <AuthBase title="Crear una cuenta" description="Introduce tus datos a continuación para crear tu cuenta">
        <Head title="Registro" />
        ...
        >
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="password" type="password" required :tabindex="3" autocomplete="new-password" name="password" placeholder="Contraseña" />
