                ...
                <DialogContent>
                    ...
                    >
                        <DialogHeader class="space-y-3">
                            ...
                            <DialogDescription>
                                Una vez que se elimine su cuenta, todos sus recursos y datos también se eliminarán permanentemente. Por favor, ingrese su
                                contraseña para confirmar que desea eliminar su cuenta de forma permanente.
                            </DialogDescription>
                        </DialogHeader>
                        ...
                        <DialogFooter class="gap-2">
                            ...
                            <Button type="submit" variant="destructive" :disabled="processing"> Eliminar Cuenta </Button>
                        </DialogFooter>
                    </Form>
                </DialogContent>
            </Dialog>
